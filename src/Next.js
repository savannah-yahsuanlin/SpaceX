                      ...
                      <Accordion>
                        ...
                        <AccordionDetails>
                          <Box sx={{ display: "flex", alignItems: 'center', justifyContent: 'space-around'}}>
                            <Typography variant="h6">
                              <Link href={value.links.article_link}>
                                Article
                              </Link>
                            </Typography>
														{value.links.video_link=== null  ? <Typography>No video</Typography> :  <iframe width="300" height="200" src={`https://www.youtube.com/embed/` + value.links.video_link.split(".be/")[1] + `?autoplay=1`} title={value.name}></iframe>}
                          </Box>
                        </AccordionDetails>
                      </Accordion>
                      <Accordion>
